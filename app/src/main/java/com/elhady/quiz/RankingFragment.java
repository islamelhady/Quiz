...
import com.elhady.quiz.Interface.RankingCallBack;
import com.elhady.quiz.Model.QuestionScore;
import com.elhady.quiz.Model.Ranking;
import com.elhady.quiz.ViewHolder.RankingViewHolder;
        ...
        questionScore.orderByChild("user").equalTo(userName)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        //After sum all score  , we need process sum variable here
